...
def main():
    ...
    # Initialize character model with default data (deep copy)
    default_character = spec_loader.get_default_character()
    initial_data = copy.deepcopy(default_character)
    character_model = CharacterModel(initial_data)
    ...
    importer = Importer(import_map, default_character)
    ...
    # Do initial refresh to ensure all widgets have correct values
    renderer.refresh_all_widgets()
